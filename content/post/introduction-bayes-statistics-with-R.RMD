...
data_causalimpact = as.zoo(Seatbelts)

pre_period = time(data_causalimpact)[c(1, 169)]
post_period = time(data_causalimpact)[c(170, 192)]


impact = CausalImpact(data_causalimpact, pre_period, post_period, list(niter = 5000))
